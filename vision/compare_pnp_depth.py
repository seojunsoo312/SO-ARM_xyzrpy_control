...
보드를 작업 영역 책상에 평평히 두고, Viewer·펜던트는 끈다.
  ...
  python vision/compare_pnp_depth.py
...
from vision.charuco import MIN_CORNERS, detect_board, draw_detection, make_board, match_points  # noqa: E402
from vision.hand_eye_calib import robust_pnp  # noqa: E402
